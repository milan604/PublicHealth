...
class DownloadCourseScreen extends StatefulWidget {
  const DownloadCourseScreen({Key key, this.animationController, this.label})
      : super(key: key);

  final AnimationController animationController;
  final String label;
  @override
  _DownloadCourseScreenState createState() => _DownloadCourseScreenState();
}

class _DownloadCourseScreenState extends State<DownloadCourseScreen>
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  // ),
                                  Text(
                                    "Download " + capitalize(widget.label),
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                      fontFamily: PHTheme.fontName,

...
class SearchDownloadedData extends StatefulWidget {
  SearchDownloadedData(
      {Key key, this.topicID, this.title, this.animationController})
      : super(key: key);
  ...
  @override
  _SearchDownloadedDataState createState() => _SearchDownloadedDataState();
}

class _SearchDownloadedDataState extends State<SearchDownloadedData>

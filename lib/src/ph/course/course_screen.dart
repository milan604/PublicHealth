import 'package:PublicHealth/src/ph/ui_view/course_materials.dart';
...
class CourseScreen extends StatefulWidget {
  const CourseScreen({Key key, this.animationController}) : super(key: key);
